...
public class ReportFacturasControl implements Serializable {
    ...
    public void generarReporte() {
        ...
        String reportPath = sc.getRealPath("vistas/administrador/reportes/reporteFacturas.jasper");
        ...
        try {
            ...
            Logger.getLogger(ReportFacturasControl.class.getName()).log(Level.SEVERE, null, ex);
        }
